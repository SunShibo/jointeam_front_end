<template>
    ...
    <div class="table" v-loading="loading">
        ...
        <!--通知-->
        <el-dialog title="添加通知" :visible.sync="dialogInfo"
                   :close-on-click-modal="closeOnClickModal">
            <el-button
                    type="text"
        ...
        <!--添加通知-->
        <el-dialog title="添加通知" :visible.sync="dialogInfoadd"
                   :close-on-click-modal="closeOnClickModal">
                ...
                <el-row>
                    <el-col :span="12" style="border-right: 1px #666666 solid">
                        <div class="grid-content bg-purple">
                            <el-form-item label="标题：" prop="title">
                                <el-input style="width: 300px" v-model="formInfo.title" size="mini"
                                          class="inputform"></el-input>
                            </el-form-item>
                            <el-form-item label="内容：" prop="content">
                                <el-input style="width: 300px" v-model="formInfo.content" size="mini"
                                          class="inputform"></el-input>
                            </el-form-item>
                        </div>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item style="margin-left:10%;width: 300px" label="图片">
                            <upLoad id-name="team1"
                                    :fileList="fileList1"
                                    :onUpLoadSuccess="onUpLoadSuccess1"
                                    :onUpLoadError="onUpLoadError1"
                                    :filesNumber="1"
                                    :showFileList="true"></upLoad>
                        </el-form-item>
                    </el-col>
    ...
    export default {
        ...
        methods: {
            ...
            onUpLoadSuccess1(uploadUrl) {
                ...
                this.fileList1 = [];
                this.fileList1.push({name: uploadUrl, url: uploadUrl});

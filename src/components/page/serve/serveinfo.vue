    ...
    <div class="table" v-loading="loading">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-cascades">服务详情</i></el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
        ...
        <el-dialog title="添加/编辑" :visible.sync="dialogFormVisible" :close-on-click-modal="closeOnClickModal">
            <el-form ref="courseform" :model="form" :rules="rules">
                <div v-if="active==1">
                    <el-form-item label="标题" prop="title" style="margin-left: 4%">
                        <el-input v-model="form.title" size="mini" class="inputform"
                                  style="width: 30%;margin-left: 3%"></el-input>
                    </el-form-item>
                ...
                <div v-if="active==2">
                    <el-form-item label="" prop="projectIntroduce">
                        <quill-editor ref="newEditor1" width="80%" height="900px" v-model="form.serveExplain"
                                      :options="editorOption"></quill-editor>
                    </el-form-item>
                </div>
                <div v-if="active==3">
                    <el-form-item label="" prop="projectIntroduce">
                        <quill-editor ref="newEditor2" width="80%" height="900px" v-model="form.caseExplain"
                                      :options="editorOption"></quill-editor>
                    </el-form-item>
                </div>
                <div v-if="active==4">
                    <el-form-item label="" prop="projectIntroduce">
                        <el-input v-model="form.serveUnit"  type="textarea" placeholder="服务单位 多个请用:英文逗号 (',') 分割" rows="20">
                            </el-input>
                    </el-form-item>
                </div>
                <el-steps :active="active" finish-status="success">
                    <el-step title="基本信息"></el-step>
                    <el-step title="服务说明"></el-step>
                    <el-step title="案例说明"></el-step>
                    <el-step title="服务单位"></el-step>
                </el-steps>
    ...
    export default {
        ...
        methods: {
                ...
                this.$refs.courseform.validate(valid => {
                    if (valid) {
                        ...
                        if (this.form.id == '' || this.form.id == null) {
                            delete this.form.id;
                            this.$axios.post('/backServer/addServerMsg', this.form).then(res => {
                                if (!res.success) {
                            ...
                            this.loading = true;
                            this.$axios.post('/backServer/updateInfo', this.form).then(res => {
                                if (!res.success) {
                                    this.$message.error(res.errMsg);
                                    this.loading = false;
                                    return;
            ...
            getData() {
                this.loading = true;
                this.$axios
                    .post('/backServer/queryMsg', {
                        pageNo: this.currentPage,
                        pageSize: this.PageSize,
                        title: this.s_projectName,

	...
	<div class="table" v-loading="loading">
		...
		<div class="container">
			<div class="handle-box">
				...
				<el-button type="primary" icon="search" @click="go">重置</el-button>
			</div>
			<!-- 信息展示 -->
			<el-table :data="tableData" border class="table" ref="multipleTable">
				...
				<el-table-column fixed="right" header-align="center" align="center" width="160" label="操作">
					<template slot-scope="scp">
						...
						<el-popconfirm title="确认删除此banner吗？" @onConfirm="handleDelete(scp.$index, scp.row)">
	...
	export default {
		...
		methods: {
			go() {
				...
				if (JSON.stringify(this.$route.params)==""||JSON.stringify(this.$route.params)==null||JSON.stringify(this.$route.params)=={}) {
					this.$router.push({
						name: 'project',
					});
				}else{
